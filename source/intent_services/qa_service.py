...
import source.intent_services
from source.audio import wait_while_speaking
from source.configuration import Configuration
from source.core import Skill
from source.llm import LLM, main_persona_prompt
from source.messagebus.message import Message
from source.util import LOG
...
class QAService:
    ...
    def match(self, utterances, lang, message):
        ...
        if self.is_question_like(utterances, lang):
            ...
            if answered:
                match = source.intent_services.IntentMatch("persona", None, None, None)
