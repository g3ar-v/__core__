              ...
              <div class="self-end mb-1 flex space-x-1.5 mr-2">
                <button
                  class="{prompt !== ''
                    ...
                    : 'text-white bg-gray-100 dark:text-gray-800 dark:bg-gray-600 disabled'} transition rounded-lg p-1 mr-0.5 w-28 h-7 self-center"
                  type="button"
              ...
              <div class="self-end mb-2 flex justify-between space-x-1.5 mr-2">
                ...
                {:else}
                  ...
                  <button
                    class="{prompt !== ''
                      ? 'bg-black text-white hover:bg-gray-900 dark:bg-white dark:text-black dark:hover:bg-gray-200 '
                      : 'text-white bg-gray-100 dark:text-gray-800 dark:bg-gray-600 disabled'} transition rounded-lg p-1 mr-0.5 w-auto h-7 self-center w-auto"
                    type="button"
