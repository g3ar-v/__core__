    ...
    <div class="flex justify-center">
      <div aria-hidden="true" class="hero-header-item hero-logo">
        <div class="hero-logo-circles">
          <img
            src="/assets/images/index-portal-red-semi.svg"
            class="hero-logo-circle"
            alt="Red Semi Circle"
          />
          <img
            src="/assets/images/index-portal-red.svg"
            class="hero-logo-circle"
            alt="Red Circle"
          />
          <img
            src="/assets/images/index-portal-orange-semi.svg"
            class="hero-logo-circle"
            alt="Orange Semi Circle"
          />
          <img
            src="/assets/images/index-portal-orange.svg"
            class="hero-logo-circle"
            alt="Orange Circle"
          />
          <img
            src="/assets/images/index-portal-yellow-semi.svg"
            class="hero-logo-circle"
            alt="Yellow Semi Circle"
          />
          <img
            src="/assets/images/index-portal-yellow.svg"
            class="hero-logo-circle"
            alt="Yellow Circle"
          />
          <img
            src="/assets/images/index-portal-green-semi.svg"
            class="hero-logo-circle"
            alt="Green Semi Circle"
          />
          <img
            src="/assets/images/index-portal-green.svg"
            class="hero-logo-circle"
            alt="Green Circle"
          />
          <img
            src="/assets/images/index-portal-blue-semi.svg"
            class="hero-logo-circle"
            alt="Blue Semi Circle"
          />
          <img
            src="/assets/images/index-portal-blue.svg"
            class="hero-logo-circle"
            alt="Blue Circle"
          />
        </div>
                ...
                {#if message.role == "user"}
                  {#if message?.edit === true}
                    <div class=" w-full">
                      ...
                      <div
                        class=" mt-2 flex justify-center space-x-2 text-sm font-medium"
                      >
                        <button
